...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/src/config/BitcoinAdult-config.h.in \
...
ZMQ_CFLAGS =  
ZMQ_LIBS = -lzmq  
abs_builddir = /root/BTAD
abs_srcdir = /root/BTAD
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_BitcoinAdult_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_BitcoinAdult_coverage.info test_BitcoinAdult.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/BTAD-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/BitcoinAdult-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/BitcoinAdult-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/BitcoinAdult-config.h
$(top_srcdir)/src/config/BitcoinAdult-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/BitcoinAdult-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/BTAD-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BTAD-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BTAD-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_BitcoinAdult.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_BitcoinAdult -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_BitcoinAdult_filtered.info: test_BitcoinAdult.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_BitcoinAdult_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_BitcoinAdult_coverage.info: baseline_filtered_combined.info test_BitcoinAdult_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_BitcoinAdult_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_BitcoinAdult_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_BitcoinAdult_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_BitcoinAdult.coverage/.dirstamp:  test_BitcoinAdult_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_BitcoinAdult.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_BitcoinAdult.coverage/ total.coverage/ $(OSX_APP)
