Contributing to BitcoinAdult Core
============================

The BitcoinAdult Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitcoinAdult Core project, and is not to be
confused with overall BitcoinAdult Network Protocol consensus changes.

Whether a pull request is merged into BitcoinAdult Core rests with the project merge
...
Patches that change BitcoinAdult consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitcoinAdult consensus, it must have been
...
The project leader is the release manager for each BitcoinAdult Core release.
