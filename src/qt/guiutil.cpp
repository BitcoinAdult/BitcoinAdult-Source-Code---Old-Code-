...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a BitcoinAdult address (e.g. %1)").arg("PCYiHgGJJ6xGHqivmdZrYjRnhaYf6AJ2Mp"));
#endif
...
{
    // return if URI is not valid or is no BitcoinAdult: URI
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "BitcoinAdult.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for BitcoinAdult.lnk
