                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitcoinAdult Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitcoinAdult address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BitcoinAdult: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBTAD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitcoinAdult Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitcoinAdult Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitcoinAdult"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitcoinAdult addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitcoinAdult addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagBitcoinAdulttic information"));
    ...
    openAction->setStatusTip(tr("Open a BitcoinAdult: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitcoinAdult Core help message to get a list with possible BitcoinAdult command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitcoinAdult Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitcoinAdult network", "", count));
}
...
{
    QString strTitle = tr("BitcoinAdult Core"); // default title
...
/** Creates context menu, its actions, and BitcoinAdults up all the relevant signals for mouse events. */
