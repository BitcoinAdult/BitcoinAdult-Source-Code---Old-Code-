...
public:
    ...
    void setZBitcoinAdultControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzXG_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzXG_clicked();
    void on_pushButtonZBitcoinAdultControl_clicked();
