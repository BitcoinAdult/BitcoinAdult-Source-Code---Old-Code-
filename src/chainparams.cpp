...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x00000ba534231b3fe87e479a802ef2e2ac083c36c0cfd6c317b3b0bc7bffef53"));
...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 1 * 60;  // BitcoinAdult: 30 Seconds
        nMaturity = 10;
        ...
        nZerocoinStartTime = 1532029205; //--- (Still requires block 200)
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1532024205;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1709856;
				
		hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000ba534231b3fe87e479a802ef2e2ac083c36c0cfd6c317b3b0bc7bffef53"));
        assert(genesis.hashMerkleRoot == uint256("0x50d967acee3091232cdb94dcaecebc26cf00e5896b7e355215f373b7d8f6ba7e"));
		...
		//vSeeds.push_back(CDNSSeedData("45.77.1.151", "45.77.1.151"));             // 
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // BitcoinAdult: 1 day
        nTargetSpacing = 1 * 60;  // BitcoinAdult: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet BitcoinAdult addresses start with 'x' or 'y'
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // BitcoinAdult: 1 day
        nTargetSpacing = 1 * 60;        // BitcoinAdult: 1 minutes
