...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BitcoinAdult server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BitcoinAdult server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitcoinAdult features */
        {"BitcoinAdult", "masternode", &masternode, true, true, false},
        ...
        {"BitcoinAdult", "mnbudget", &mnbudget, true, true, false},
...
#ifdef ENABLE_WALLET
        {"BitcoinAdult", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use BitcoinAdultd, or the -server option to BitcoinAdult-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8119/\n";
}
