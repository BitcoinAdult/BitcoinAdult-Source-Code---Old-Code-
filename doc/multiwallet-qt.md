...
In order to support loading of multiple wallets in BitcoinAdult-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is BitcoinAdult.cpp.
...
Changes to BitcoinAdult.cpp
----------------------
BitcoinAdult.cpp is the entry point into BitcoinAdult-qt, and as such, will require some minor modifications to provide hooks for
