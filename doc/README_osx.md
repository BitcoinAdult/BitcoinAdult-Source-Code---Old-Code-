...
This file is several bitcoinadultbytes in size, but only a single directory inside is
needed:
```
...
- **TODO** The Apple keyholder uses this unsigned app to create a detached signature,
  using the script that is also included there. Detached signatures are available from this [repository](https://github.com/eastcoastcrypto/BitcoinAdult-detached-sigs).
